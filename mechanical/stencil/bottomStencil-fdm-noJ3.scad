// Generated by SolidPython 1.1.3 on 2026-08-31 21:13:46
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
		scale(v = [1, 1, 1]) {
			difference() {
				linear_extrude(height = 1.5000000000) {
					offset(r = 1.6000000000) {
						import(file = "/home/thebu/newhome/softek/pico2-knob/mechanical/stencil/pico2-knob-EdgeCuts.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 0.8000000000) {
			offset(chamfer = false, delta = 0.0500000000) {
				import(file = "/home/thebu/newhome/softek/pico2-knob/mechanical/stencil/pico2-knob-PasteBottom-noJ3.dxf", origin = [0, 0]);
			}
		}
	}
}
