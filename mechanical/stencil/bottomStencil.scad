// Generated by SolidPython 1.1.3 on 2026-08-31 20:26:12
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
		...
		linear_extrude(center = true, height = 0.8000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "/home/thebu/newhome/softek/pico2-knob/mechanical/stencil/pico2-knob-PasteBottom.dxf", origin = [0, 0]);
			}
		}
	}
}
